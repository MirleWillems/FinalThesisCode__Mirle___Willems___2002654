...
if 1:
    ...
    desc += '-custom_dataset_3'; dataset = EasyDict(tfrecord_dir='custom_dataset_3', resolution=512); train.mirror_augment = False
    ...
    # Number of GPUs.
    desc += '-1gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4} #32:64 changed to 32:32
