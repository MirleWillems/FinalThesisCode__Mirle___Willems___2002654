...
ls = dnnlib.EasyDict(func_name='metrics.run_latents_linear_separability.LS', name='ls', num_samples=5000, num_keep=2500, attrib_indices=range(1), minibatch_per_gpu=32) #'metrics.linear_separability.LS', num_samples=200000, num_keep=100000 minibatch = 50
