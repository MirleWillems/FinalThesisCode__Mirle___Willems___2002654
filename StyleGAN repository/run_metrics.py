...
def main():
    ...
    tasks = []
    tasks += [EasyDict(run_func_name='run_metrics.run_pickle', network_pkl='results/00009-sgan-custom_dataset_3-1gpu/network-snapshot-006566.pkl', dataset_args=EasyDict(tfrecord_dir='custom_dataset_3', shuffle_mb=0), mirror_augment=True)] # karras2019stylegan-ffhq-1024x1024.pkl #'
